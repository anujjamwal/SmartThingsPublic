/*
 *  Zooz ZEN76 700 S2 Switch VER. 1.0.1
 *
 *  Changelog:
 *
 *    1.0.1 (02/07/2021)
...
metadata {
	definition (
		...
		fingerprint mfr:"027A", prod:"7000", model: "A006", deviceJoinName:"Zooz ZEN76 700 S2 Switch"
...
// 0x00 is not supported by device, but should be...
def ledIndicatorOff() {
...
Map getRelayControlParam() {
	return getParam(12, "Relay Control", 1, 1, [1:"Enable paddle and Z-Wave [DEFAULT]", 0:"Disable Paddle", 2:"Disable Paddle and Z-Wave"])
}
